...
const EditVehicleModal = (props: { _id: string }) => {
    ...
    const getVehicle = async () => {
      ...
      axios(axiosConfig)
        .then((response) => {
          ...
          setBrand(response.data.vehicle.brand);
          setBrandModel(response.data.vehicle.brandModel);
              ...
              >
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="mt-4 flex items-center justify-end">
                    <button
                      type="button"
                      className="inline-flex justify-center rounded-md border border-transparent bg-darkBlue px-4 py-2 text-sm font-medium text-white hover:bg-darkBlue/75 focus:outline-none capitalize"
                      onClick={() => {
                        editVehicle();
                        closeModal();
                      }}
